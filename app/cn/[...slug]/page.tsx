    ...
    sections: [
      {
        ...
        kind: "cards",
        items: [
          ["双人 12 小时门票", "2 位大人同行 · 买一送一 · RM169++ 起 / 2 位", "泡池、汗蒸、桑拿、休息区与晚餐都包含。"],
          ["单人 12 小时门票", "RM169++ 起 / 人 · 送 30 分钟按摩", "一个人也能完整享受 12 小时，适合独自放松。"],
          ["日间按摩配套", "RM199++ / 人 · 9AM-5PM", "任选按摩、足疗或排毒护理，白天进场最划算。"],
          ["扬州搓澡配套", "RM199++ 起 / 人", "传统搓澡，已含 12 小时门票，不需要另买入场券。"],
          ["沐净舒养套餐", "RM379++ / 人", "12 小时门票、30 分钟搓澡、60 分钟按摩一次安排好。"],
          ["日间双人套餐", "RM379++ / 2 人", "两位日间入场，每人一项 60 分钟护理。"],
        ],
      },
      {
        id: "combos",
      ...
      },
      {
        ...
        kind: "cards",
        items: [
          ["全身项目", "舒缓触感、热石排毒、法式尊宠、五行至尊 SPA。", "价格 RM369++ 起。"],
          ["足疗项目", "经典足疗与足疗配套。", "价格 RM299++ 起。"],
          ["指压项目", "局部调理、推拿、传统泰式按摩。", "价格 RM199++ 起。"],
          ["小项目", "耳疗、修脚、拔罐、刮痧、扬州搓澡、背踩等。", "价格 RM150++ 起。"],
        ],
      },
      {
        id: "know",
    ...
    sections: [
      {
        ...
        kind: "cards",
        items: [
          ["冰火两重天", "13°C 玄冰池与 43°C 中药池冷热交替。", "星空顶下泡完通体舒畅。"],
          ["盐晶汗蒸", "暖光盐晶墙汗蒸房。", "泡完汤后坐着发汗，循环更舒畅。"],
          ["按摩房", "独立三床按摩房。", "家人朋友可同房安排推拿、泰式、精油等护理。"],
          ["扬州搓澡", "专设搓澡房。", "传统手艺搓出一身轻，可单项或配套购买。"],
          ["影视厅 · 休息厅", "每个座位配耳机。", "看电影或睡觉互不打扰。"],
          ["足浴房", "电动躺椅足浴房。", "足疗、修脚后顺势休息。"],
          ["餐厅", "晚餐自助 6PM-9PM。", "其他时段有简餐、水果与冰淇淋。"],
          ["私人房", "高尔夫主题房与包间。", "适合聚会、比赛夜与团体使用。"],
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        kind: "cards",
        items: [
          ["经典 2 小时上门按摩", "RM699 · 60 分钟精油 + 60 分钟泰式。", "9AM-10PM 可预约，适合白天或晚上完整放松。"],
          ["随时 2 小时上门按摩", "RM798 · 固定 120 分钟。", "可告诉我们想混合精油、推拿、泰式或足疗。"],
          ["四手尊宠 2 小时", "RM1,699 · 两位技师同步。", "肩背和腿部同时护理，释放更快更深。"],
        ],
      },
      {
        id: "outcall-flow",
    ...
    sections: [
      {
        ...
        kind: "cards",
        items: [
          ["项目内容", "身体焕亮、水光面部护理、手部护理。", "同日温泉门票已包含。"],
          ["适合人群", "肤色暗沉、干燥缺水、手部粗糙。", "适合重要场合前想让状态更亮的人。"],
          ["价格", "RM599", "先泡汤汗蒸，再到美容部完成护理。"],
        ],
      },
      {
        id: "beauty-light",
        ...
        kind: "cards",
        items: [
          ["光子嫩肤", "针对暗沉、粗糙与肤色不均。", "护理后肤色看起来更透亮。"],
          ["淡斑护理", "针对面部色素沉着。", "现场皮肤评估后确认方案与价格。"],
          ["冰点脱毛", "810nm 冰点技术。", "按部位报价，也可组合多部位。"],
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        kind: "cards",
        items: [
          ["全身经络药拓调理", "72 种中草药药包配合专业技法疏通经络。", "RM699"],
          ["艾灸", "温经散寒，行气通络，扶阳固本。", "RM199"],
          ["草本泥灸", "温热草本泥包覆调理，第一分钟就很舒服。", "RM199"],
          ["中医正骨调理", "经中医师评估后调理筋骨关节。", "RM598"],
          ["女性私密养护", "独立房间，女性专员一对一服务。", "价格 WhatsApp 咨询。"],
        ],
      },
      {
        id: "physician",
        ...
        kind: "cards",
        items: [
          ["针灸", "由中医师按体质与情况选穴。", "RM598"],
          ["小针刀", "针对慢性软组织黏连与顽固疼痛。", "RM878"],
          ["刺络", "疏通局部经络，调和气血。", "RM338"],
        ],
      },
    ],
  },
...
function SectionContent({ section }: { section: CnPage["sections"][number] }) {
  ...
  return (
    <div className={section.kind === "cards" ? "minis" : "knowwrap"}>
      {section.items.map(([title, desc, note]) => (
        <article className={section.kind === "cards" ? "mini-card" : "know"} key={title}>
          <h3>{title}</h3>
