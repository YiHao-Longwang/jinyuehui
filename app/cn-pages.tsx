...
export const cnPageSeo: Record<string, { title: string; description: string; path: string; keywords: string[]; image?: string }> = {
  packages: {
    title: "吉隆坡SPA价目 | 普通入场与按摩价格 · 金悦汇 Indulgence",
    description:
      "金悦汇 Indulgence吉隆坡SPA价目：普通 12 小时入场、儿童票、按摩护理、搓背去角质与包厢价格，线上即可预约。",
    path: "/packages/",
    keywords: ["吉隆坡SPA价格", "吉隆坡按摩价格", "吉隆坡水疗价目", "金悦汇价目", "吉隆坡温泉价格"],
    image: "/assets/hero-packages-rain.jpg",
  },
  facilities: {
    title: "吉隆坡SPA设施 | 汤泉汗蒸桑拿包厢 · 金悦汇 Indulgence",
    description:
      "金悦汇 Indulgence位于吉隆坡 Viva Home Mall：冷热汤池、岩盐蒸房房、桑拿、按摩包厢、搓背房、休息大厅与餐饮区，24 小时开放。",
    path: "/facilities/",
  ...
  faq: {
    ...
    description:
      "金悦汇 Indulgence常见问题：12 小时使用时间、平日与周末价格、儿童票、停车与到店流程，一次看清楚。",
    path: "/faq/",
  ...
  contact: {
    ...
    description:
      "金悦汇 Indulgence地址：吉隆坡 Viva Home Mall LG Floor，24 小时营业，WhatsApp +60 14-315 5632 预约吉隆坡SPA与按摩。",
    path: "/contact/",
  ...
  "terms-conditions": {
    ...
    description: "金悦汇 Indulgence条款与细则：服务项目、价格说明与到店流程。",
    path: "/terms-conditions/",
    keywords: ["金悦汇条款", "吉隆坡SPA条款"],
  },
  "privacy-policy": {
    title: "隐私政策 | 金悦汇 Indulgence 吉隆坡SPA",
    description: "金悦汇 Indulgence隐私政策：联系资料的使用范围与保护方式。",
    path: "/privacy-policy/",
...
const cnFallbackSeo = {
  ...
  description:
    "金悦汇 Indulgence中文页面：吉隆坡SPA、吉隆坡按摩、吉隆坡娱乐、24 小时汤泉、价目、设施、美容、中医与联系资料。",
  path: "/",
...
export function BeautyPageCn() {
  return (
    <>
      ...
      <main id="main-content" lang="zh-Hans">
        <Hero eyebrow="金悦汇 Indulgence · 美容部 · 吉隆坡" title={<>美容护理，现在也在 金悦汇 Indulgence</>} copy="美容项目按普通价目咨询确认。另外还有光子嫩肤、淡斑护理与冰点脱毛，都要先预约。" image="beauty-hero.jpg?osw=0.9.23" />
...
export function FaqPageCn() {
  return (
    <>
      ...
      <main id="main-content" lang="zh-Hans"><section id="faq"><SectionHead eyebrow="到店前" title="FAQ · 金悦汇"sub="价格、设施、儿童票、停车与到店流程都在这里。还有不清楚，直接 WhatsApp 找真人。" /><div className="container"><div className="faqwrap"><div className="faq">{faqRows.map(([question, answer], index) => <details open={index === 0} key={question}><summary>{question}<span className="plus" /></summary><div className="a">{answer}</div></details>)}</div></div></div></section></main>
      <Footer locale="cn" />
      <FloatingWhatsApp locale="cn" />
    </>
  );
        ...
        <section id="contact">
          ...
          <div className="container">
            ...
            <div className="btnrow contact-actions">
              ...
              <a className="btn line" href="https://waze.com/ul?q=Jinyuehui%20Indulgence%20Viva%20Home%20Mall" target="_blank" rel="noopener">打开 Waze</a>
            </div>
            <div className="deal contact-note"><b>唯一门店</b> - 金悦汇 Indulgence 只有这一间门店，位于吉隆坡 Taman Miharja 的 Viva Home Mall LG Floor。我们没有分店，请导航到以上地址。</div>
          </div>
        </section>

        <section id="visit">
          <SectionHead eyebrow="到店前" title="怎么来金悦汇吉隆坡SPA会所" sub="营业时间、停车、预约流程与门票包含什么。" />
